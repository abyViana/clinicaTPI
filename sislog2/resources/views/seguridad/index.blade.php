...
@section ('contenido')
    ...
    <div class="row">
        ...
        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
            <center>
            <img src="{{asset('img/user.png')}}" alt="Generic placeholder image" width="140" height="140">
            </center>
        ...
        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
            <center>
            <img src="{{asset('img/docto.png')}}" alt="Generic placeholder image" width="140" height="140">
            </center>
