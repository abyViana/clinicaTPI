...
<body>
  <header class="clearfix">
    <div class="container">
      ...
      <div class="company-info">
        <h2 class="title">Clinica Medica Betel</h2>
        <div class="address">
          ...
          <p>
            Barrio el Angel, Rosario de la Paz<br>
          </p>
        </div>
        <div class="phone">
          <span class="icon">
          ...
          <a href="tel:602-519-0450">2531-2078</a>
        </div>
        <div class="email">
          ...
          <a href="mailto:company@example.com">clinicaBetel@gmail.com</a>
        </div>
      </div>
    </div>
  </header>
    ...
    <div class="container">
      <div class="details clearfix">
        <div class="client middle">
          <p class="name Justified">El Medico con Nombre  <b>{{$incapacidad->medicoAsignado}} </b>
          ...
          Por lo que se le incapacita por: <u><b>{{$incapacidad->diasIncapacidad}} días</b></u>.</p>
          <p class="name Justified">
  ...
  <footer>
    <div class="container">
<div class="thanks">Gracias por utilizar nuestros servicios!</div>
      <div class="notice">
        <div>Firma de Medico:</div><br>
        <div>Firma de Paciente:</div>
      </div>
      <div class="end">Clama a mi y yo te respondere Jeremias 33:3</div>
    </div>
  </footer>
