...
<h1 align="center" > Sistema Informatico para la gestión de procedimientos de la Clinica Medica</h1>
    <div class="row">
        <div class="col-lg-4">
        ...
        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
            ...
            <center><h3>Gestion de Incapacidad</h3></center><br><center><a href="clinica/incapacidad"><button class="btn btn-success">Entrar</button></a></center>
        </div>
        </div>
    </div>
    <br>
...
-->
        ...
        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
            <center>
            <img src="{{asset('img/examen.png')}}" alt="Generic placeholder image" width="140" height="140">
            </center>
