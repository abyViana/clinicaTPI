...
@section ('contenido')
   <div class="row">
        <div class="col-lg-10 col-md-6 col-sm-6 col-xs-12">
            <h2 align="center" class="text-aqua">Crear Nueva Consulta</h2>
    ...
    <div class="form-horizontal">
        ...
        <div class="col-sm-6">
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <input type="date" value="{{old('fechaConsulta')}}" name="fechaConsulta" class="form-control" required pattern="(?:19|20)[0-9]{2}-(?:(?:0[1-9]|1[0-2])/(?:0[1-9]|1[0-9]|2[0-9])|(?:(?!02)(?:0[1-9]|1[0-2])/(?:30))|(?:(?:0[13578]|1[02])-31))" placeholder="yyyy/mm/dd">  
                </div>     
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    ...
                    <option value="2">Control de embarazo</option>
                    <option value="3">Control de niño</option>
