  ...
  <body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
            ...
            <div class="col-md-12">
              <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title">Sistema de Gestion de Procedimientos de la Clinica Medica</h3>
      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2019 <a href="http://www.faceboook.com">TPI</a>.</strong> All rights reserved.
      </footer>
